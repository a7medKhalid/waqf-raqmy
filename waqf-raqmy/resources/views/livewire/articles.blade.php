                    ...
                    @foreach($articles as $article)
                        <div class="m-4 block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <button type="button" class="bg-red-600  px-6 py-2.5 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-500 hover:shadow-lg focus:bg-red-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-600 active:shadow-lg transition duration-150 ease-in-out">حذف</button>
                            ...
                            @if($article->isPublished)
                                    <button type="button" class="  px-6 py-2.5 bg-slate-400 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-slate-600 hover:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out">أرشفة</button>
                                @else
