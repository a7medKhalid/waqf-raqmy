    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <header class="flex flex-col items-center justify-center max-w-xl mx-auto mt-20 text-center mb-11">
                <h1 class="text-4xl">
                    <span class="text-blue-500">الوقف الرقمي </span>مفتوح المصدر
                </h1>

                <h2 class="inline-flex mt-2">مقالات يكتبها المجتمع للمجتمع</h2>

                <p class="text-sm m-14">
                    هنا حيث نثري مفهوم الوقف الرقمي مفتوح المصدر بتعريفات ومقترحات وأفكار لتطويره يمكن للجميع أن يشارك ليكتب تصوره عن الوقف الرقمي مفتوح المصدر ومايميزه
                </p>
